...
const expenses: Expense[] = [
  { id: "1", description: "House Mortgage", categoryId: "Mortgage", unitCost: 769.65, frequency: "monthly", expenseType: "recurring", isActive: true },
  { id: "2", description: "House Service Charge", categoryId: "Maintenance", unitCost: 208.8, frequency: "monthly", expenseType: "recurring", isActive: true },
  { id: "3", description: "House Ground Rent", categoryId: "Maintenance", unitCost: 35, frequency: "monthly", expenseType: "recurring", isActive: true },
  { id: "4", description: "House Building Insurance", categoryId: "Maintenance", unitCost: 58.1975, frequency: "monthly", expenseType: "recurring", isActive: true },
  { id: "5", description: "Council Tax", categoryId: "Utilities", unitCost: 142, frequency: "monthly", expenseType: "recurring", isActive: true },
  { id: "6", description: "Energy (Electricity & Gas)", categoryId: "Utilities", unitCost: 56.39, frequency: "monthly", expenseType: "recurring", isActive: true },
  { id: "7", description: "Internet", categoryId: "Utilities", unitCost: 25, frequency: "monthly", expenseType: "recurring", isActive: true },
  { id: "8", description: "House Savings", categoryId: "Maintenance", unitCost: 150, frequency: "monthly", expenseType: "recurring", isActive: true },
  { id: "9", description: "Runescape", categoryId: "Subscriptions", unitCost: 7.99, frequency: "monthly", expenseType: "recurring", isActive: true },
  { id: "10", description: "Work Bus", categoryId: "Transport", unitCost: 40, frequency: "monthly", expenseType: "recurring", isActive: true },
  { id: "11", description: "Amazon Prime", categoryId: "Subscriptions", unitCost: 95, frequency: "yearly", expenseType: "recurring", isActive: true },
  { id: "12", description: "Food", categoryId: "Food", unitCost: 150, frequency: "monthly", expenseType: "recurring", isActive: true },
  { id: "13", description: "Eat-out", categoryId: "Personal Spending", unitCost: 80, frequency: "monthly", expenseType: "recurring", isActive: true },
  { id: "14", description: "Savings", categoryId: "Savings", unitCost: 300, frequency: "monthly", expenseType: "recurring", isActive: true },
  { id: "15", description: "Phone", categoryId: "Utilities", unitCost: 18.08, frequency: "monthly", expenseType: "recurring", isActive: true },
  { id: "16", description: "Gym", categoryId: "Subscriptions", unitCost: 42, frequency: "monthly", expenseType: "recurring", isActive: true },
  { id: "17", description: "Trading 212", categoryId: "Investment", unitCost: 300, frequency: "monthly", expenseType: "recurring", isActive: true },
  { id: "18", description: "PayPal PC", categoryId: "Credit", unitCost: 77.17, frequency: "monthly", expenseType: "recurring", isActive: true },
  { id: "19", description: "PayPal Fractal", categoryId: "Credit", unitCost: 0.01, frequency: "monthly", expenseType: "recurring", isActive: false }, // 0-cost line skipped (schema requires cost > 0)
  { id: "20", description: "VirginMoney", categoryId: "Credit", unitCost: 0.01, frequency: "monthly", expenseType: "recurring", isActive: false },
  { id: "21", description: "Boiler", categoryId: "Credit", unitCost: 94.92, frequency: "monthly", expenseType: "recurring", isActive: true },
  { id: "22", description: "Climbing Centre", categoryId: "Subscriptions", unitCost: 48, frequency: "monthly", expenseType: "recurring", isActive: true },
];
